...
{
    public class ServiciosAutores : IServiciosAutores
    {
        private readonly AplicationDBContext context;
        private readonly IHttpContextAccessor httpContextAccessor;
        private readonly IMapper mapper;

        public ServiciosAutores(AplicationDBContext context, IHttpContextAccessor httpContextAccessor, IMapper mapper)
        {
